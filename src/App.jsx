  ...
  return (
    <div style={S.app}>
      ...
      <div>
        ...
        {module === "agriScale"  && <AgriScaleModule  key={`as-${activeFarm.id}`}  farmId={activeFarm.id}  farmName={activeFarm.name}  tenantId={effectiveTenantId} token={session.idToken} userProfile={{...impersonatedProfile, role: impersonatedProfile.moduleRoles?.agriScale   || impersonatedProfile.role}} persist={persist} initialTab={pendingTab}/>}
