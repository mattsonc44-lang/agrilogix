      ...
      <div style={{maxWidth:"800px",margin:"0 auto"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"14px"}}>
          ...
          <div style={{display:"flex",gap:"8px"}}>
            <button onClick={handlePrint} style={{background:"#e8e2d8",border:"1px solid #4a5568",color:"#4a5568",fontFamily:"'IBM Plex Mono',monospace",fontSize:"11px",padding:"8px 20px",borderRadius:"4px",cursor:"pointer"}}>ð¨ PRINT / SAVE PDF</button>
            <button onClick={onClose} style={{background:"#fff0f0",border:"1px solid #e0c0c0",color:"#c05040",fontFamily:"'IBM Plex Mono',monospace",fontSize:"11px",padding:"8px 16px",borderRadius:"4px",cursor:"pointer"}}>â CLOSE</button>
          </div>
        </div>
        <div ref={reportRef} style={{background:"#fff",color:"#111",fontFamily:"'IBM Plex Sans',sans-serif",padding:"28px 32px",borderRadius:"6px",border:"1px solid #ddd"}}>
          ...
          <div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:"9px",letterSpacing:"0.2em",color:"#888",marginTop:"20px",marginBottom:"8px",paddingTop:"12px",borderTop:"1px solid #ddd"}}>ALL LOADS â DETAILED</div>
          <table>
            <thead><tr>
              ...
              {allLoads.map((load,i)=>{
                ...
                return (
                  <tr key={load.id} style={{background:i%2===1?"#f9f9f9":"#fff"}}>
                    ...
                    <td style={td}>{load.operator ? <span style={{background:"#e8f4e0",borderRadius:"3px",padding:"1px 7px",fontFamily:"'IBM Plex Mono',monospace",fontSize:"10px",color:"#3a6a28"}}>{load.operator}</span> : <span style={{color:"#bbb",fontSize:"10px"}}>â</span>}</td>
                    ...
                    <td style={td}><span style={{background:"#e8f0e8",borderRadius:"3px",padding:"1px 7px",fontFamily:"'IBM Plex Mono',monospace",fontSize:"10px"}}>{binForLoad?binForLoad.name:"â"}</span></td>
                    <td style={td}>
                      {load.truckColor ? (
                      ...
                      ) : <span style={{color:"#aaa",fontSize:"10px"}}>â</span>}
                    </td>
              ...
              {(fields||[]).map(field=>{
                ...
                return (
                  <tr key={field.id}>
                    ...
                    <td style={{...td,textAlign:"right",fontFamily:"'IBM Plex Mono',monospace"}}>{acres||"â"}</td>
                    ...
                    <td style={{...td,textAlign:"right",fontFamily:"'IBM Plex Mono',monospace"}}>{acres>0?(totBu/acres).toFixed(1)+" bu/ac":"â"}</td>
                  </tr>
                );
              })}
            </tbody>
